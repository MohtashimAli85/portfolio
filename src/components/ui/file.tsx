...
const FileContent = ({ children }: { children: React.ReactNode }) => {
  ...
  return (
    <div className="[counter-reset:line] whitespace-pre-wrap font-mono text-sm md:text-base xl:text-lg text-theme-foreground">
      {formattedLines.map((line) => (
        ...
        >
          ...
          <span className="table-cell text-right text-theme-foreground pr-2 md:pr-10 select-none before:content-[counter(line)]" />
