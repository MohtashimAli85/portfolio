  ...
  return (
    <section className='flex items-center h-full px-5 md:px-0 py-20 md:py-24 md:ml-[15%] md:mr-[10%]  md:max-w-[75%] '>
      <div className='flex h-full max-h-[510px] w-full'>
        <div className='flex flex-col relative -z-0 justify-between md:basis-1/2 md:space-y-20'>
            <Shadow color="primary" top={0} left={-15} />
            <Shadow color="secondary" top={150} right={-15} />
